...
odoo.define("ssi_vendor_bill_claude_code.vendor_bill_claude_code_backend_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // does not resolve to one — see the Python docstring.
            {
                ...
                trigger: ".o_statusbar_buttons button[name='action_test_connection']:enabled",
                run: function () {
                    // Assertion only.
                },
            },
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Find and open the record to edit
            {
                ...
                trigger: ".o_data_row:contains(TOUR-BACKEND-EDIT) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the record, then delete via the form's Action menu
            {
                ...
                trigger: ".o_data_row:contains(TOUR-BACKEND-DELETE) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Record is open",
            ...
            {
                content: "Click the [Vendor Bill AI Backends] breadcrumb to return to the list",
                trigger: ".breadcrumb-item.o_back_button a:contains(Vendor Bill AI Backends)",
            },
