...
2. Open the record.
3. On the **Detail** tab, click the **Compute Tax** button below the
   detail lines.

## Post-Condition

- The **Taxes** table on the **Detail** tab is recomputed from the detail
  lines: existing tax lines are replaced by the tax(es) configured on each
  detail line.
